/**
 * Installation script for EasyCoder daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the easycoder command. 
 * 
 ...
 * 2. We assume users will run easycoder frequently (every time they open their laptop)
...
const PLIST_LABEL = 'com.easycoder-cli.daemon';
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the easycoder CLI executable
        const easycoderPath = process.argv[0]; // Node.js executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.easycoder/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.easycoder/daemon.log</string>
        ...
        logger.info('Check logs at ~/.easycoder/daemon.log');
