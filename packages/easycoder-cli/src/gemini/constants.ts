...
export const CHANGE_TITLE_INSTRUCTION = trimIdent(
  `Based on this message, call functions.easycoder__change_title to change chat session title that would represent the current task. If chat idea would change dramatically - call this function again to update the title.`
);
