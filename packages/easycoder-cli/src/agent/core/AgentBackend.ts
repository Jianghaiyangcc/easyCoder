 ...
 * the EasyCoder CLI and mobile app.
 * 
 ...
 * These messages are forwarded to the EasyCoder server and mobile app.
 */
 ...
 * this interface to be usable through the EasyCoder CLI and mobile app.
 */
