...
vi.mock('@/claude/utils/startEasycoderServer', () => ({
  startEasycoderServer: mocks.mockStartHappyServer,
}));
...
describe('runAcp', () => {
  ...
  it('updates session metadata with ACP config options (models and operating modes)', async () => {
    ...
    const baseMetadata = {
      ...
      easycoderLibDir: '/repo/.easycoder/lib',
      easycoderToolsDir: '/repo/.easycoder/tools',
    };
