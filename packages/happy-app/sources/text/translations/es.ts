...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Code Never Stops es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Code Never Stops válido',
    ...
    sessionInfo: {
        ...
        failedToCopySessionId: 'Falló al copiar ID de sesión',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Usa tu propio agente de ElevenLabs en lugar del predeterminado de Code Never Stops. No se requiere suscripción — conéctate directamente con tu propia cuenta de ElevenLabs. Tu agente debe definir dos herramientas de cliente: messageClaudeCode (envía texto al agente de código) y processPermissionRequest (permite o deniega el uso de herramientas). Recibe el contexto de la sesión a través de la variable dinámica {{initialConversationContext}}.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'No configurado',
        customAgentIdDescription: 'Ingresa tu ElevenLabs Agent ID. Déjalo vacío para usar el predeterminado de Code Never Stops.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Conexión directa',
        bypassTokenSubtitle: 'Omite el servidor de Code Never Stops, conéctate directamente a ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Code Never Stops. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
