...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        about: '關於',
        aboutFooter: '碼不停蹄是一個 Codex 和 Claude Code 行動用戶端。它採用端對端加密，您的帳戶僅儲存在本機裝置上。與 Anthropic 無關聯。',
        whatsNew: '更新日誌',
    ...
    settingsAppearance: {
        ...
        themeDescriptions: {
            ...
            dark: '始終使用深色主題',
            zinc: '低飽和度的中性深色方案',
            midnight: '帶有些微藍色調的冷色深色方案',
            claude: '帶有琥珀底色的暖色深色方案',
        },
        display: '顯示',
    ...
    settingsVoice: {
        ...
        byoTitle: '使用自己的代理',
        byoDescription: '使用您自己的 ElevenLabs 代理取代碼不停蹄預設代理。無需訂閱 — 直接使用您自己的 ElevenLabs 帳戶連線。您的代理必須定義兩個用戶端工具：messageClaudeCode（向編碼代理傳送文字）和 processPermissionRequest（允許或拒絕工具使用）。透過 {{initialConversationContext}} 動態變數接收工作階段上下文。',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: '未設定',
        customAgentIdDescription: '輸入您的 ElevenLabs Agent ID。留空則使用碼不停蹄預設代理。',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: '直接連線',
        bypassTokenSubtitle: '跳過碼不停蹄伺服器，直接連線到 ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有終端正在請求連線到您的碼不停蹄帳戶。這將允許終端安全地傳送和接收訊息。',
