...
export const LocalSettingsSchema = z.object({
    ...
    markdownAstEnabled: z.boolean().describe('Use AST-based markdown parsing pipeline'),
    customServerEnabled: z.boolean().describe('Enable custom gateway server configuration and entry point'),
