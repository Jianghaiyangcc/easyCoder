...
export const zhHans: TranslationStructure = {
    ...
    connect: {
        ...
        enterUrlManually: '手动输入URL进行设备认证',
    ...
    settings: {
        ...
        eula: '最终用户许可协议',
        supportUs: '加入我们',
        supportUsSubtitlePro: '感谢您的加入！',
        supportUsSubtitle: '扫描二维码加入我们',
        scanQrCodeToAuthenticate: '扫描二维码进行设备认证',
        ...
        systemStatus: '系统状态',
        systemStatusSubtitle: '检查客户端、网关和机器连接',
    ...
    subscription: {
        ...
        alreadyProMessage: '您已是专业版订阅用户。',
        manageSubscriptionMessage: '如需管理订阅，请前往 iOS 的 App Store 或 Android 的 Google Play。',
        availablePlans: '可选套餐',
        terms: '服务条款',
        privacy: '隐私政策',
        footer: '订阅即表示您同意我们的服务条款和隐私政策。',
        features: {
            unlimitedAI: '无限 AI 对话',
    ...
    errors: {
        ...
        voiceHardLimitReached: ({ hours }: { hours: number }) => `您本月已使用超过 ${hours} 小时的语音。这是允许的最大用量。您可以在语音设置中切换语音模式，或配置自己的实时语音代理以使用自有配额。`,
    ...
    settingsVoice: {
        currentModeTitle: '当前语音模式',
        currentModeDescription: '语音能力会随模式变化。可选择更轻量的语音输入，或连续对话的实时语音助手。',
        commonTitle: '常用设置',
        voiceModeTitle: '语音模式',
        voiceModeSubtitle: '选择语音输入或实时语音助手',
        modePickerTitle: '选择语音模式',
        modePickerMessage: '推荐先使用语音输入模式。实时语音助手属于高级模式。',
        modeVoiceInputLabel: '语音输入',
        modeVoiceInputDescription: '先录音，再将语音转成文字发送到当前会话。',
        modeRealtimeAssistantLabel: '实时语音助手',
        modeRealtimeAssistantDescription: '与实时语音代理持续对话，并联动编码会话。',
        providerBailian: '百炼',
        ...
        preferredLanguageSubtitleInput: '用于语音识别转写',
        preferredLanguageSubtitleRealtime: '用于实时语音助手响应',
        microphonePermission: '麦克风权限',
        microphonePermissionGranted: '已授权，可正常使用语音功能。',
        microphonePermissionDenied: '未授权，点击申请权限或前往系统设置。',
        language: {
        ...
        usageFooterBailian: '展示过去 30 天的语音输入用量。当前模式下不显示实时会话次数。',
        usageFooterElevenLabs: '展示过去 30 天的实时语音用量，并包含会话次数限制。',
        usageUnavailableTitle: '暂时无法获取用量',
        usageUnavailableSubtitle: '当前无法加载语音用量，请稍后再试。',
        usageLabel: '语音时间',
        ...
        advancedDescription: '仅在需要自定义实时语音代理时使用。',
        advancedLockedTitle: '高级实时配置已隐藏',
        advancedLockedSubtitle: '切换到“实时语音助手”模式后可配置自定义 Agent。',
        helpTitle: '模式差异说明',
        helpVoiceInput: '适合快速指令：说一句，转写后发送一句。',
        helpRealtimeAssistant: '适合连续协作：可与语音代理持续对话。',
        statusBar: {
            connectingRealtime: '正在连接实时语音...',
            connectedRealtime: '实时语音助手已连接',
            recordingVoiceInput: '正在录音',
            transcribingVoiceInput: '正在转写语音...',
            connectionError: '语音连接异常',
            voiceAssistant: '语音助手',
            tapToEnd: '点击结束',
            tapToStopRecording: '点击停止录音',
        },
    },
    ...
    settingsAccount: {
        ...
        phone: '手机号',
        phoneFooter: '绑定手机号后，账户更容易识别。',
        phoneNumber: '手机号',
        phoneNotBound: '未绑定',
        bindPhone: '绑定手机号',
        changePhone: '更换手机号',
        bindPhoneSubtitle: '发送验证码并完成校验。',
        unbindPhone: '解绑手机号',
        unbindPhoneSubtitle: '将当前手机号从此账户移除。',
        enterPhoneTitle: '绑定手机号',
        enterPhoneMessage: '请输入中国大陆手机号，可不带 +86。',
        enterPhonePlaceholder: '例如 13800138000',
        enterCodeTitle: '输入验证码',
        enterCodeMessage: ({ phone }: { phone: string }) => `请输入发送到 ${phone} 的验证码`,
        enterCodePlaceholder: '6 位验证码',
        phoneEmptyError: '请输入手机号',
        codeEmptyError: '请输入验证码',
    ...
    modals: {
        ...
        scannerNotAvailable: '当前设备不支持扫码。请改用粘贴认证 URL。',
        failedToOpenScanner: '无法打开扫码器。请重试或改用粘贴认证 URL。',
    },
    ...
    help: {
        title: '系统状态',
        subtitle: '快速确认当前配置是否已可用。',
        overallStatus: '总体状态',
        statusAvailable: '可用',
        statusPartial: '部分可用',
        statusUnavailable: '不可用',
        availableHint: '你现在可以开始新会话。',
        partialHint: '网关已连接，但没有在线机器。',
        unavailableHint: '请先连接账户或网关。',
        clientSection: '客户端',
        clientType: '客户端类型',
        clientTypeWeb: 'Web 应用',
        clientTypeIOS: 'iOS 应用',
        clientTypeAndroid: 'Android 应用',
        clientTypeDesktop: '桌面应用',
        appVersion: '应用版本',
        accountStatus: '账户状态',
        accountConnected: '已连接',
        accountNotConnected: '未连接',
        gatewaySection: '网关',
        gatewayAddress: '网关地址',
        gatewayAddressOfficial: '官方服务器',
        gatewayMode: '网关模式',
        gatewayModeDefault: '默认',
        gatewayModeCustom: '自定义',
        gatewayConnection: '连接状态',
        machinesSection: '机器',
        machinesTotal: '机器总数',
        machinesOnline: '在线机器',
        machinesOffline: '离线机器',
        noMachines: '还没有连接任何机器',
        actionsSection: '操作',
        connectTerminal: '连接终端',
        enterUrlManually: '手动输入 URL',
        openServerConfig: '打开服务器配置',
        startNewSession: '开始新会话',
    },

    welcome: {
        // Main welcome screen for unauthenticated users
        title: '能装进口袋的Vibe Coding助手',
        subtitle: '支持最强编程工具：Claude Code / Codex / Opencode；也支持 Openclaw 等',
        createAccount: '创建账户',
    ...
    usage: {
        ...
        freeLimitsFooterMonthly: ({ month }: { month: string }) => `${month} · 免费用户上限见上方，按各指标分别生效`,
        proLimitsFooterMonthly: ({ month }: { month: string }) => `${month} · Pro 用户无限制`,
        last6MonthsFooter: '前 6 个完整自然月（不含当月）',
        totalTokens: '总令牌数',
        totalCost: '总费用',
        tokens: '令牌',
        cost: '费用',
        ...
        messageCount: '总消息数',
        voiceCount: '语音次数',
        voiceAsrCount: '语音识别次数',
        voiceMinutes: '语音分钟数',
        globalMessageCount: '消息发送总数',
        unlimited: '无限制',
        limitReachedTitle: '已达到使用上限',
        limitReachedSubtitle: ({ metric }: { metric: string }) => `${metric} 已达到免费额度上限`,
