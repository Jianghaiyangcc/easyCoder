/**
 * Chinese (Traditional) translations for the EasyCoder app
 * Values can be:
...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        systemStatus: '系統狀態',
        systemStatusSubtitle: '檢查客戶端、閘道與機器連線',
    ...
    subscription: {
        ...
        alreadyProMessage: '您已是專業版訂閱用戶。',
        manageSubscriptionMessage: '如需管理訂閱，請前往 iOS 的 App Store 或 Android 的 Google Play。',
        availablePlans: '可用方案',
        terms: '服務條款',
        privacy: '隱私政策',
        footer: '訂閱即表示您同意我們的服務條款與隱私政策。',
        features: {
            unlimitedAI: '無限 AI 對話',
            prioritySupport: '優先技術支援',
            exclusiveFeatures: '專屬功能',
            adFree: '無廣告體驗',
        },
    },
    ...
    errors: {
        ...
        voiceHardLimitReached: ({ hours }: { hours: number }) => `您本月已使用超過 ${hours} 小時的語音。這是允許的最大用量。您可以在語音設定中切換語音模式，或配置自己的即時語音代理以使用自有配額。`,
        voiceConversationLimitReached: '您本月已達到語音對話的最大次數。我們未來可能會新增按需語音使用功能——如果您遇到此限制，請在 github.com/Jianghaiyangcc/easyCoder/issues 提交 issue。',
    ...
    sessionInfo: {
        ...
        easycoderSessionIdCopied: '工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製工作階段 ID 失敗',
        easycoderSessionId: '工作階段 ID',
        ...
        updateCliInstructions: '請執行 npm install -g easycoder@latest',
    ...
    settingsVoice: {
        currentModeTitle: '目前語音模式',
        currentModeDescription: '語音能力會隨模式變化。可選擇更輕量的語音輸入，或連續對話的即時語音助理。',
        commonTitle: '常用設定',
        voiceModeTitle: '語音模式',
        voiceModeSubtitle: '選擇語音輸入或即時語音助理',
        modePickerTitle: '選擇語音模式',
        modePickerMessage: '建議先使用語音輸入模式。即時語音助理屬於進階模式。',
        modeVoiceInputLabel: '語音輸入',
        modeVoiceInputDescription: '先錄音，再將語音轉為文字傳送到目前工作階段。',
        modeRealtimeAssistantLabel: '即時語音助理',
        modeRealtimeAssistantDescription: '與即時語音代理持續對話，並聯動編碼工作階段。',
        providerBailian: '百鍊',
        ...
        preferredLanguageSubtitleInput: '用於語音辨識轉寫',
        preferredLanguageSubtitleRealtime: '用於即時語音助理回應',
        microphonePermission: '麥克風權限',
        microphonePermissionGranted: '已授權，可正常使用語音功能。',
        microphonePermissionDenied: '未授權，點擊申請權限或前往系統設定。',
        language: {
        ...
        usageFooterBailian: '顯示過去 30 天的語音輸入用量。此模式下不顯示即時會話次數。',
        usageFooterElevenLabs: '顯示過去 30 天的即時語音用量，並包含會話次數限制。',
        usageUnavailableTitle: '暫時無法取得用量',
        usageUnavailableSubtitle: '目前無法載入語音用量，請稍後再試。',
        usageLabel: '語音時間',
        conversationsLabel: '對話',
        usageUsed: ({ used, limit }: { used: string; limit: string }) => `已使用 ${used}，共 ${limit}`,
        supportTitle: '升級語音',
        supportSubtitle: '獲取更多語音時間並支持開發',
        advancedTitle: '進階設定（可選）',
        advancedDescription: '僅在需要自訂即時語音代理時使用。',
        advancedLockedTitle: '進階即時設定已隱藏',
        advancedLockedSubtitle: '切換到「即時語音助理」模式後可設定自訂 Agent。',
        helpTitle: '模式差異說明',
        helpVoiceInput: '適合快速指令：說一句，轉寫後送一句。',
        helpRealtimeAssistant: '適合連續協作：可與語音代理持續對話。',
        statusBar: {
            connectingRealtime: '正在連線即時語音...',
            connectedRealtime: '即時語音助理已連線',
            recordingVoiceInput: '正在錄音',
            transcribingVoiceInput: '正在轉寫語音...',
            connectionError: '語音連線異常',
            voiceAssistant: '語音助理',
            tapToEnd: '點擊結束',
            tapToStopRecording: '點擊停止錄音',
        },
    },
    ...
    settingsAccount: {
        ...
        phone: '手機號',
        phoneFooter: '綁定手機號後，帳戶更容易識別。',
        phoneNumber: '手機號',
        phoneNotBound: '未綁定',
        bindPhone: '綁定手機號',
        changePhone: '更換手機號',
        bindPhoneSubtitle: '發送驗證碼並完成校驗。',
        unbindPhone: '解除綁定手機號',
        unbindPhoneSubtitle: '將目前手機號從此帳戶移除。',
        enterPhoneTitle: '綁定手機號',
        enterPhoneMessage: '請輸入中國大陸手機號，可不帶 +86。',
        enterPhonePlaceholder: '例如 13800138000',
        enterCodeTitle: '輸入驗證碼',
        enterCodeMessage: ({ phone }: { phone: string }) => `請輸入發送到 ${phone} 的驗證碼`,
        enterCodePlaceholder: '6 位驗證碼',
        phoneEmptyError: '請輸入手機號',
        codeEmptyError: '請輸入驗證碼',
    ...
    modals: {
        ...
        scannerNotAvailable: '目前裝置不支援掃碼。請改用貼上驗證 URL。',
        failedToOpenScanner: '無法開啟掃碼器。請重試或改用貼上驗證 URL。',
    },
    ...
    help: {
        title: '系統狀態',
        subtitle: '快速確認目前配置是否已可用。',
        overallStatus: '整體狀態',
        statusAvailable: '可用',
        statusPartial: '部分可用',
        statusUnavailable: '不可用',
        availableHint: '您現在可以開始新的工作階段。',
        partialHint: '閘道已連線，但沒有在線機器。',
        unavailableHint: '請先連線帳戶或閘道。',
        clientSection: '客戶端',
        clientType: '客戶端類型',
        clientTypeWeb: 'Web 應用',
        clientTypeIOS: 'iOS 應用',
        clientTypeAndroid: 'Android 應用',
        clientTypeDesktop: '桌面應用',
        appVersion: '應用版本',
        accountStatus: '帳戶狀態',
        accountConnected: '已連線',
        accountNotConnected: '未連線',
        gatewaySection: '閘道',
        gatewayAddress: '閘道地址',
        gatewayAddressOfficial: '官方伺服器',
        gatewayMode: '閘道模式',
        gatewayModeDefault: '預設',
        gatewayModeCustom: '自訂',
        gatewayConnection: '連線狀態',
        machinesSection: '機器',
        machinesTotal: '機器總數',
        machinesOnline: '在線機器',
        machinesOffline: '離線機器',
        noMachines: '尚未連線任何機器',
        actionsSection: '操作',
        connectTerminal: '連線終端',
        enterUrlManually: '手動輸入 URL',
        openServerConfig: '開啟伺服器設定',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `easycoder daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g easycoder@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
    ...
    usage: {
        ...
        freeLimitsFooterMonthly: ({ month }: { month: string }) => `${month} · 免費用戶上限見上方，按各指標分別生效`,
        proLimitsFooterMonthly: ({ month }: { month: string }) => `${month} · Pro 用戶無限制`,
        last6MonthsFooter: '前 6 個完整自然月（不含當月）',
        totalTokens: '總權杖數',
        totalCost: '總費用',
        tokens: '權杖',
        cost: '費用',
        ...
        messageCount: '總消息數',
        voiceCount: '語音次數',
        voiceAsrCount: '語音識別次數',
        voiceMinutes: '語音分鐘數',
        globalMessageCount: '消息傳送總數',
        unlimited: '無限制',
        limitReachedTitle: '已達到使用上限',
        limitReachedSubtitle: ({ metric }: { metric: string }) => `${metric} 已達到免費額度上限`,
