...
- [x] Create `src/config.ts` — reads `HAPPY_SERVER_URL` (default: `https://codeapi.daima.club`), `HAPPY_HOME_DIR` (default: `~/.happy`), derives credential file path as `${happyHomeDir}/agent.key`
