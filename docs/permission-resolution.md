...
- Mapping to Claude happens in `packages/easycoder-cli/src/claude/utils/permissionMode.ts`:
...
`packages/easycoder-app/sources/sync/storage.ts`
...
`packages/easycoder-app/sources/app/(app)/new/index.tsx`
`packages/easycoder-app/sources/components/NewSessionWizard.tsx`
...
`packages/easycoder-cli/src/claude/runClaude.ts`
`packages/easycoder-cli/src/claude/utils/permissionMode.ts`
...
`packages/easycoder-cli/src/claude/claudeLocal.ts`
