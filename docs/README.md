# Code Never Stops Docs

This folder documents how Code Never Stops works internally, with a focus on protocol, backend architecture, deployment, and the CLI tool. Start here.
...
- easycoder-wire.md: Shared wire schemas/types package and migration notes.
...
## Conventions
- Paths and field names reflect the current implementation in `packages/easycoder-server`.
