...
How a single EasyCoder user is identified across every external service.

## Primary ID: EasyCoder Account CUID
...
```
EasyCoder Account CUID (e.g. cm4x7k2...)
│
...
| System | ID Type | Why |
|--------|---------|-----|
| ElevenLabs | HMAC-derived | Privacy — raw EasyCoder ID never sent to ElevenLabs |
...
To derive an ElevenLabs user ID from a EasyCoder CUID locally:
